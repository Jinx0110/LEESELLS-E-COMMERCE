...
let httpRequest = new XMLHttpRequest()
{
    httpRequest.onreadystatechange = function()
    {
        if(this.readyState === 4 && this.status == 200)
        {
            ...
            {
                contentDetails.preview = "img/desktop-PC1.jpg"; // Main image
                contentDetails.photos = [
                    "img/desktop-PC2.jpg",
                    "img/desktopPC-3.jpg",
                    "img/desktopPC-4.jpg",
                    "img/desktopPC-4.jpg"
    // Add more if needed
                ...
                contentDetails.name = "New Product Name";
contentDetails.brand = "Seller Name";
contentDetails.price = 999;
contentDetails.description = "Product details";
